...
Nun wird durch das benutzen der Drehschieberpumpe der Aufbau auf seine Dichtigkeit überprüft. Es sollte sich ein Enddruck im Bereich von $\SI{0,03}{\milli\bar}$ bis $\SI{0,05}{\milli\bar}$
einstellen. Als Messgerät wird das Pirani-Vakuummeter verwendet. Wenn dies nicht erreicht wird, sollten die Ventile und abdichtungen zwischen zwei Bauteilen nochmal überprüft werden.
Desweiteren wird der wird der Rezipient einige Minuten mit der Drehschieberpumpe evakuiert, um mögliche Wasseranlagerungen von der Innenoberfläche zu entfernen und damit die Desorptionsrate 
zu vermindern.
...
wird mit der Drehschieberpumpe der Rezipient evakuiert bis ein Enddruck $p_{\mathrm{E}}$ erreicht ist, welcher notiert wird. Mittels des Dosierventil 11 wird wieder Luft in den Rezipient 
gelassen, bis der Normaldruck erreicht ist. Der Rezipient wird nun 5 mal evakuiert und dazwischen wieder belüftet. Es werden bei vorher festgelegten Drücken die benötigten Zeiten mittels des 
Pirani-Vakuummeter gemessen.\\
Für die Leckratenmessung zur Bestimmung des Saugvermögens werden bei laufender Pumpe mittels des Dosierventieles Gleichgewichtsdrücke $p_{\mathrm{g}}$ eingestellt. Diese Betragen 
...
der zunehmende Druck gemessen. Es wird wieder für vorher festgelegte Drücke die Zeit gemessen und notiert. Für jeden Gleichgewichtsdruck wird die Messung 3 mal wiederholt.
...
Die Messung der Evakuierungskurve wird wie zuvor durchgeführt, nur das der Rezipient mit dem Dosierventiel in diesen Teil auf einen Druck von $\SI{5e-3}{\milli\bar}$ eingestellt wird, 
...
Die Volumina der restlichen Bauteile werden aus dem Leitfaden entnommen.