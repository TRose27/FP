...
Wenn die mittlere Weglänge viel größer ist als der Durchmesser liegt die molekulare Strömung vor. Daher kommt es kaum noch zu stößen unter den Gasteilchen, sonder fast nur noch mit den
...
\begin{equation}
    ...
    \label{eqn:leitwert}
\end{equation}
wobei $l$ die Länge der verwendeten Rohrleitungen ist.\cite{leitwert}

\subsection{Sorption}
Sorption ist ein Überbegriff für das anreichern eines Stoffes innerhalb einer Phase oder an der Grenzfläche zwischen zwei Phasen. Bei der Absorption absorptier eine Phase z.B. ein Feststoff
...
\begin{figure}[H]
    ...
    \label{fig:drehpumpe}
\end{figure}\FloatBarrier
In Abbildung \ref{fig:drehpumpe} ist der schematische Aufbau einer Drehschieberpumpe dargestellt. Der exzentrisch eingebaute Rotor befinden sich trennt den Einlass vom Auslass. Das Gehäuse
...
vom ölüberlagerten Auslassventil in den Stator, wodurch die Schieber geölt werden und gegen den Schieber abgedichtet werden. Der Arbeitsbereich einer Drehschieberpumpe liegt im Grob- und
