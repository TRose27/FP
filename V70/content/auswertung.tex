...
\begin{equation}
  \begin{split}
  &\Delta \ln \Bigl(\frac{p(t)-p_E}{p_0-p_E}\Bigr) = \\
  &\sqrt{\frac{(\Delta p_{0})^{2}}{\left(p_{0} - p_{E}\right)^{2}} + \frac{(\Delta p_{E})^{2} \left(p_{0} - p_{E}\right)^{2}}{\left(- p_{E} + {p(t)}\right)^{2}} \left(- \frac{1}{p_{0} - p_{E}} + \frac{- p_{E} + {p(t)}}{\left(p_{0} - p_{E}\right)^{2}}\right)^{2} 
...
\begin{align*}
  S_1 &= \SI{10.0\pm0.7}{\litre\per\second} \\
  S_2 &= \SI{21.1\pm1.6}{\litre\per\second} \\
  S_3 &= \SI{22.5\pm1.7}{\litre\per\second} \\
  S_4 &= \SI{18.0\pm1.3}{\litre\per\second}.
\end{align*}
\begin{figure}
    \centering
