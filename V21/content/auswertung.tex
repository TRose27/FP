...
\begin{equation}
  ...
  \label{eqn:hh}
\end{equation}
berechneten Magnetfeldstärken sind in Tabelle \ref{tab:1} aufgetragen. Die Werte für die Windungen und Radien der Spulen wurden aus \cite{sample} entnommen.
\begin{table}
  \centering
...
\end{align*}
Mit denselben Werten wird nun zum Vergleich der lineare Zeeman-Effekt zu
\begin{align*}
  U_\text{85} &= \SI{7.5\pm0.40e-28}{\joule} \\
  U_\text{87} &= \SI{7.2\pm0.21e-28}{\joule}
\end{align*}
berechnet. Somit ist der maximale quadratische Effekt um zwei bis drei Größenordnungen kleiner als der lineare und kann somit in guter Näherung vernachlässigt werden.
