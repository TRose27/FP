...
plt.subplot(4,2,8)
plt.grid()
plt.plot(f7,a7,ls="-",color="orange",label="600mm")
plt.ylabel(r'Amplitude')
plt.xlabel(r'f / $\si{\hertz}$')
plt.legend(loc="best")
