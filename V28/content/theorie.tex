...
\begin{equation}
 \mu_z = - \frac{1}{2} \frac{e_0}{m_0} m \hbar = \mu_B m
 \label{eq:muz}
\end{equation}
...
This whole process is called electron spin resonance and with the energy of the used radiation following connection can be found:
\begin{equation}
  h \nu = g \mu_B B.
\end{equation}
