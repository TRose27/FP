...
$m_0=\SI{9,11e-31}{\kilo\gram}$. Der experimentelle bestimmte Wert von $m^*_{\mathrm{exp}} = \SI{1,26e-32}{\kilo\gram}=0,014m_0$ entspricht daher einer Abweichung 
von $\SI{79,34}{\percent}$ vom Literaturwert.
...
Oszilloskop ein Minimum angezeigt hat. Welches von diesen Minima das tatsächlich kleinste war, ließ sich nicht sagen.\\
