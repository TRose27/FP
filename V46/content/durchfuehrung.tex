...
\begin{figure}
    ...
    \label{fig:aufbau}
\end{figure}
Diese besteht zunähst einmal aus einer Halogen-Lampe als Lichtquelle und einer Linse zur Fokussierung.
...
Zur Kalibrierung des Gerätes wird nun der Interferenzfiltern entfernt und geprüft ob der Lichtsrahl auf beide Photowiderstände trifft, und ob bei geeigneter
